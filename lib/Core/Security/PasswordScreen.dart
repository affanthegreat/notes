      ...
      body: Column(
        ...
        children: [
          Container(
            ...
            child: Text(
              "Inside Vault, you can hide your personal notes that you don't want others to never know about them.",
              style: poppins(foreground.withOpacity(0.7), h3 - 2, FontWeight.w500),
            ),
          ),
          ConstrainedBox(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                border: Border.all(color: foreground.withOpacity(0.25), width: 0.4),
              ...
              child: TextField(
                ...
                style: poppins(foreground.withOpacity(0.7), h2 - 4, FontWeight.w500),
                obscureText: true,
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Center(
        child: Text(
          "Unlock Vault",
          style: poppins(foreground.withOpacity(0.7), h3, FontWeight.w600),
        ),
      ),
    );
  }
